...
function binarySearch(sortedNums, searchNum) {
    ...
    // base
    if (sortedNums[midIndex] === searchNum || sortedNums[midIndex-1] === searchNum || sortedNums[midIndex+1] ){
        return true
    }
    ...
    if(sortedNums[midIndex] < searchNum) {
        return binarySearch(sortedNums.slice(midIndex,sortedNums.length), searchNum)
    } else {
